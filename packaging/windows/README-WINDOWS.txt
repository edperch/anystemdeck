AnyStemDeck Windows Portable Alpha
===============================
...
2. Double-click AnyStemDeck.exe.
...
- Runtime, config, and logs stay under data/, next to AnyStemDeck.exe, not in AppData.
...
- Your job history and library are stored separately (Documents/AnyStemDeck by default,
...
- The empty portable.txt file next to AnyStemDeck.exe is what tells the app to use
